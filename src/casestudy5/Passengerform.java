       	...
       	if(M.isSelected())
       		...
       		else
       		{
       			gender="FEMALE";
					...
					textArea.setText(textArea.getText()+"\n\n"+T1.getText()+"\t     "+age+" "+gender+"\t\t"+sa+"\t\t\t\t"+amount);
					if(sa.equals("Sleeper")) {
					textArea.setText(textArea.getText()+"\tSL"+"\t\t"+amount);
					
					}
					if(sa.equals("Seater"))
					{
						textArea.setText(textArea.getText()+"\tSE"+"\t\t"+amount);
						
					}
					else if(sa.equals("Semi-Sleeper"))
					{
						textArea.setText(textArea.getText()+"\tSS"+"\t\t"+amount);
